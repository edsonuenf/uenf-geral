...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--20)">
    ...
    <div class="wp-block-group faq-accordion-container">
        ...
        <details class="wp-block-details has-base-2-background-color has-background" style="margin-bottom:var(--wp--preset--spacing--20);border-radius:8px">
            ...
            <p style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">Você pode entrar em contato conosco através do formulário de contato, email ou telefone. Estamos disponíveis de segunda a sexta, das 9h às 18h.</p>
            <!-- /wp:paragraph -->
        </details>
        <!-- /wp:details -->
        ...
        <details class="wp-block-details has-base-2-background-color has-background" style="margin-bottom:var(--wp--preset--spacing--20);border-radius:8px">
            ...
            <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} -->
            <p style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">Funcionamos de segunda a sexta-feira, das 9h às 18h. Aos sábados, das 9h às 12h. Domingos e feriados estamos fechados.</p>
            <!-- /wp:paragraph -->
        </details>
        <!-- /wp:details -->
        ...
        <details class="wp-block-details has-base-2-background-color has-background" style="margin-bottom:var(--wp--preset--spacing--20);border-radius:8px">
            ...
            <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} -->
            <p style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">Nosso processo é dividido em etapas: análise inicial, proposta, desenvolvimento, testes e entrega. Mantemos comunicação constante durante todo o projeto.</p>
            <!-- /wp:paragraph -->
        </details>
        <!-- /wp:details -->
        ...
        <details class="wp-block-details has-base-2-background-color has-background" style="margin-bottom:var(--wp--preset--spacing--20);border-radius:8px">
            ...
            <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} -->
            <p style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">Sim, oferecemos suporte técnico por 30 dias após a entrega do projeto. Também temos planos de manutenção mensal para atualizações e melhorias contínuas.</p>
            <!-- /wp:paragraph -->
        </details>
        <!-- /wp:details -->
    </div>
