        ...
        <div class="footer-widgets">
            <div class="footer-widget">
                <a href="https://uenf.br" target="_blank" class="footer-logo">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/logo-Uenf-vertical-sem-assinatura.png"
                        alt="UENF">
                </a>
            </div>
            <div class="footer-widget">
            ...
            <?php if (get_theme_mod('disable_footer_sidebar', false)): ?>
                <?php add_filter('body_class', function ($classes) {
                    $classes[] = 'footer-sidebar-disabled';
                    return $classes; }); ?>
            <?php endif; ?>
        </div>
    </div>
